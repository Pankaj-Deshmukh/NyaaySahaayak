            ...
            <div className="Main-body">
              ...
              <div className="Footer">
                <input className="SearchBar" placeholder="Search..." type="search"/>
                  <button className="SearchButton"><img className="SearchBar-img" src="Images/search.svg" alt="search" /></button>
                  <button className="voice-search"><img className="voice-search-img" src="Images/voice-search-icon.svg" alt="voice-search" /></button>
              </div>
            </div>
          </div>
        </body>
